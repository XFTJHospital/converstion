...
# ====================================
# 6. 分开保存每个组件，增强兼容性与可读性
# ====================================
joblib.dump(model, "rHCC_xgb_model.pkl")
joblib.dump(target_le, "rHCC_target_encoder.pkl")
joblib.dump(label_encoders, "rHCC_feature_encoders.pkl")
